...
test('it renders', function(assert) {
  ...
  const testShow = {
    ...
    "logoImage": {
      ...
      "source": null,
      "url": "https://www.wnyc.org/i/1400/1400/l/80/1/2DQ_1400X1400_NoWNYCSTUDIOS_2.png",
      "h": 1400,
      "isDisplay": true,
      "crop": "l",
      "caption": "",
      "template": "https://www.wnyc.org/i/%s/%s/%s/%s/1/2DQ_1400X1400_NoWNYCSTUDIOS_2.png",
      "w": 1400,
      "id": 151040,
  ...
  assert.equal(this.$('.flag-image img').attr("src"), "https://www.wnyc.org/i/90/90/l/99/1/2DQ_1400X1400_NoWNYCSTUDIOS_2.png", "Image is populated");
  ...
  assert.equal(this.$('.flag-image img').attr("src"), "https://www.wnyc.org/i/150/150/l/99/1/2DQ_1400X1400_NoWNYCSTUDIOS_2.png", "Image is populated");
  assert.equal(this.$('.flag-body .text h2 a').attr("data-tracking-category"), "Test Category", "Tracking Category should render on title link");
  assert.equal(this.$('a.flag-image').attr("data-tracking-category"), "Test Category", "Tracking Category should render on image link" );
